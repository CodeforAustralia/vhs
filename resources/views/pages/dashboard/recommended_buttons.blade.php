    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-8 recommended_links-wrapper">
                ...
                <a href="#" target="_blank" role="button" class="btn btn-default need_housing_button">{!! file_get_contents(asset(public_path('images/ico-urgenthousing.svg'))) !!} <span>Need urgent housing?</span></a>
                </div>
                <div class="recommended_buttons col-md-12 col-lg-12">
