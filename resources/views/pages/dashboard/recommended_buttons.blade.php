            ...
            <div class="col-md-8 recommended_links-wrapper">
                <div class="recommended_buttons col-md-12 col-lg-12">
                  <a href="#" target="_blank" role="button" class="need_housing_button">
                    ...
                    <span>Need urgent housing?</span>
                    <span class="external-link">{!! file_get_contents(public_path('images/ico-external-link.svg')) !!}</span>
                  </a>
                </div>
                <div class="recommended_buttons col-md-12 col-lg-12">
                  <a href="http://housing.vic.gov.au/housing-options-finder" target="_blank" role="button" class="housing_options_button">
                ...
                <div class="recommended_buttons col-md-12 col-lg-12">
                  <a href="http://housing.vic.gov.au/housing-options-finder" target="_blank" role="button" class="housing_options_button">
                    ...
                    <span>Nearest Housing Office</span>
                    <span class="external-link">{!! file_get_contents(public_path('images/ico-external-link.svg')) !!}</span>
                  </a>
                </div>
            </div>
