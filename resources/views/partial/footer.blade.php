			...
			<div class="col-md-10 footer-wrapper">
				...
				<div id="nrs-div" class="col-md-5">
					...
					<div class="footer-text" style="margin-top: 6px;">
						Deaf, hearing or speech impaired? Contact the National Relay Service: Call <a href="#" style="color: #ffffff; text-decoration: underline;">1800 555 660</a> or visit <a href="http://www.relayservice.com.au" target="_blank" style="color: #ffffff; text-decoration: underline;">www.relayservice.com.au&nbsp;<span class="external-link">{!! file_get_contents(public_path('images/ico-external-link.svg')) !!}</span></a>
					</div>
				</div>
			</div>
		</div><!-- /.row -->
